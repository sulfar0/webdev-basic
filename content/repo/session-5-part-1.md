...
* ADA. (2019). *Americans with Disabilities Act of 1990, as Amended*. U.S. Department of Justice. Retrieved from [https://www.ada.gov/](https://www.ada.gov/)
* Felke-Morris, T. (2019). *Basics of Web Design: HTML5 & CSS* (5th ed.). Pearson.
* Google Developers. (2020). *Image Optimization*. Retrieved from [https://developers.google.com/web/fundamentals/performance/optimizing-content-efficiency/image-optimization](https://developers.google.com/web/fundamentals/performance/optimizing-content-efficiency/image-optimization)
* Google. (2021). *Core Web Vitals*. Retrieved from [https://web.dev/vitals/](https://web.dev/vitals/)
* Lazar, J., Goldstein, D. F., & Taylor, A. (2017). *Ensuring Digital Accessibility through Process and Policy*. Morgan Kaufmann.
* Mozilla Developer Network (MDN). (2021). *Images in HTML*. Retrieved from [https://developer.mozilla.org/en-US/docs/Learn/HTML/Multimedia\_and\_embedding/Images\_in\_HTML](https://developer.mozilla.org/en-US/docs/Learn/HTML/Multimedia_and_embedding/Images_in_HTML)
* Nielsen, J. (2018). *Usability Guidelines for Web Images*. Nielsen Norman Group. Retrieved from [https://www.nngroup.com/articles/images/](https://www.nngroup.com/articles/images/)
* Nielsen Norman Group. (2018). *Website Response Times*. Retrieved from [https://www.nngroup.com/articles/response-times-3-important-limits/](https://www.nngroup.com/articles/response-times-3-important-limits/)
* W3C. (2018). *HTML Standard: The img element*. World Wide Web Consortium. Retrieved from [https://html.spec.whatwg.org/multipage/embedded-content.html#the-img-element](https://html.spec.whatwg.org/multipage/embedded-content.html#the-img-element)
